 ...
 * @author amit
 */
public interface TransportAnalyzerRepository extends JpaRepository<TransportAnalyzerEntity, Long>{
	
	public TransportAnalyzerEntity findByPacketIdEntity(PacketIdEntity packetIdEntity);
