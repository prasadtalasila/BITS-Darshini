...
public class StoredViewController {
	...
	private List<StoredPacket> getStoredPackets(){
		...
		for(PacketIdEntity pie : packets){
			...
			LinkAnalyzerEntity lae = linkAnalyzerRepository.findByPacketIdEntity(pie);
			NetworkAnalyzerEntity nae = networkAnalyzerRepository.findByPacketIdEntity(pie);
			TransportAnalyzerEntity tae = transportAnalyzerRepository.findByPacketIdEntity(pie);
